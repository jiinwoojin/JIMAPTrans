...
namespace JIMapTrans.Model3DConverter.Converters
{
    public class NModel3DConverter
    {
            ...
            string input_root_directory_path, string output_root_directory_path, string temporary_root_directory_path, string input_file_extension)
        {
            ...
            string output_levelled_output_directory_path = FileSystemUtil.GetAbsolutePath(output_root_directory_path, ZoomLevel.ToString());
        ...
        private bool DoCopyTemporaryTileSetToOutputDirectory(string temporary_obj_file_path, string output_directory_path)
        {
            ...
            var batch_directory_path = FileSystemUtil.GetAbsolutePath(batch_directory_parent_path, batch_directory_name);
            var temporary_tile_set_file_path = FileSystemUtil.GetAbsolutePath(batch_directory_path, "tileset.json");
            var temporary_b3dm_file_path = FileSystemUtil.GetAbsolutePath(batch_directory_path, string.Format("{0}.b3dm", base_name));

            var output_temporary_tile_set_file_path = FileSystemUtil.GetDestinationFilePath(batch_directory_path, output_directory_path, temporary_tile_set_file_path);
            var output_temporary_b3dm_file_path = FileSystemUtil.GetDestinationFilePath(batch_directory_path, output_directory_path, temporary_b3dm_file_path);
