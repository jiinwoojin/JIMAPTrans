...
namespace JIMapTrans.Vrt
{
    public partial class VrtCreatePathSettingControl : UserControl
    {
        ...
        {
            CommonUtil.SetTextboxPlaceHolder(_inputTextBox, _inputPlaceHolderString);
            CommonUtil.SetTextboxPlaceHolder(_outputTextBox, _outputPlaceHolderString);
        }
        ...
        public List<string> GetInputPathList(PathInfo pathInfo)
        {
            ...
            {
                pathList = CommonUtil.GetPathListFromTextFile(pathInfo.InputPathString);
            }
            else
            {
