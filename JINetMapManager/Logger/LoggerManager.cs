...
namespace JIMapTrans.Logger
{
    ...
    public class LoggerManager
    {
        ...
        public static void WriteMapConvertInfoLog(MapConvertInfo mapConvertInfo)
        {
            ...
            logString += "[변환 정보]";
            logString += Environment.NewLine;
            logString += string.Format(" 경로 유형 : {0}", CommonUtil.GetEnumDescription(mapConvertInfo.MapConvertPathInfo.SelectedPathType));
            logString += Environment.NewLine;
        ...
        public static void WriteOverviewCreateInfoLog(OverviewCreateInfo info)
        {
            ...
            logString += string.Format(" 경로 유형 : {0}", CommonUtil.GetEnumDescription(info.OverviewCreatePathInfo.SelectedPathType));
            logString += Environment.NewLine;
            ...
            logString += Environment.NewLine;
            logString += string.Format(" 오버뷰 포맷 : {0}", CommonUtil.GetEnumDescription(info.OverviewFormat));
            logString += Environment.NewLine;
            logString += string.Format(" 리샘플링 옵션 : {0}", CommonUtil.GetEnumDescription(info.OverviewResamplingOption));
            logString += Environment.NewLine;
        ...
        public static void WriteVrtCreateInfoLog(VrtCreateInfo info)
        {
            ...
            logString += Environment.NewLine;
            logString += string.Format(" 경로 유형 : {0}", CommonUtil.GetEnumDescription(info.VrtCreatePathInfo.SelectedPathType));
            logString += Environment.NewLine;
