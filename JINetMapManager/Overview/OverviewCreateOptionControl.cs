...
namespace JIMapTrans.Overview
{
    public partial class OverviewCreateOptionControl : UserControl
    {
        ...
        {
            CommonUtil.LoadComboBoxItems(_overviewFormatComboBox, typeof(OverviewOptionEnum.OverviewForamt));
            CommonUtil.LoadComboBoxItems(_overviewResamplingComboBox, typeof(GdalEnum.ResamplingType));
