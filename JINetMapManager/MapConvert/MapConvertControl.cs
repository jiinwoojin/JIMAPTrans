...
namespace JIMapTrans.MapConvert
{
    public partial class MapConvertControl : UserControl
    {
        ...
        {
            CommonUtil.SetProgressBar(progressBar1, 0, _mapConvertInfo.MapConvertPathInfo.InputPathList.Count, 1, 0);
        ...
        private void StopConvert(RunWorkerCompletedEventArgs e)
        {
            ...
            LoggerManager.WriteProcessResultInfoLog(_mapConvertResultInfo);
